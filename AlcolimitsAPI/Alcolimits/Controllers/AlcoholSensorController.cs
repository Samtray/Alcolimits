...
namespace Alcolimits.Controllers
{
    public class AlcoholSensorController : ApiController
    {
        ...
        public HttpResponseMessage Get()
        {
            ...
            DataTable dt = GetData("exec GetAlcohol");
            ...
            var json = new JavaScriptSerializer().Serialize(alcohols);
            return Request.CreateResponse(HttpStatusCode.OK, alcohols);
        }

        public HttpResponseMessage Get(int id)
        {
            //List<ConAlcoholSensor> alcohols = new List<ConAlcoholSensor>();
            DataTable dt = GetData(string.Format("exec GetAlcoholId '{0}'", id));
            //for (int i = 0; i < dt.Rows.Count; i++)
            //{
                ConAlcoholSensor alcohol = new ConAlcoholSensor
                {
                ...
                //alcohols.Add(alcohol);
            //}
            var json = new JavaScriptSerializer().Serialize(alcohol);
            return Request.CreateResponse(HttpStatusCode.OK, alcohol);
        }
        ...
        [Route("api/alcoholSensor/alh1")]
        [HttpGet]
        public HttpResponseMessage getAlh1()
        {
       
            DataTable dt = GetData("exec GetALH1");
        ...
        [Route("api/alcoholSensor/alh2")]
        [HttpGet]
        public HttpResponseMessage getAlh2()
        {

            DataTable dt = GetData("exec GetALH2");
        ...
        [Route("api/alcoholSensor/alh3")]
        [HttpGet]
        public HttpResponseMessage getAlh3()
        {

            DataTable dt = GetData("exec GetALH3");
